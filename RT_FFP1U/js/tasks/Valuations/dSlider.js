class SliderManager {
    ...
    static listenOnSlider(clickArgs, clickFunc) {
        ...
        form.oninput = function () {
          ...
          //  output.value = parseFloat(slider.val()).toFixed(1);
        };
...
function generateSubmitButton(n) {
    return `<button id="ok" class="btn custom-button m-2 ">Submit</button>`;
}
...
export{SliderManager,rangeInputRun, range,appendElement,generateSubmitButton,generateImg,generateQuestion}
